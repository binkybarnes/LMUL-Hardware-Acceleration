...
REM
REM Generated by Vivado on Mon Feb 09 23:22:09 -0800 2026
...
echo "xvlog --incr --relax -prj tb_lmul_vlog.prj"
call xvlog  --incr --relax -prj tb_lmul_vlog.prj -log xvlog.log
